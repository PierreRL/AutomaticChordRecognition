...
base_call = f"python {REPO_HOME}/src/data/create_cached_datasets.py --input_dir={DATA_HOME} --output_dir={DATA_HOME}"
...
for hop_length in hop_lengths:
    ...
    expt_call = f"{base_call} " f"--hop_length={hop_length} --create_cqts"
