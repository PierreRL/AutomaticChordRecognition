...
input_dir = f"{DATA_HOME}/cached/4096/chords"
output_dir = f"{DATA_HOME}/cached/4096/chords/augs"
...
base_call = f"python {REPO_HOME}/src/data/pitch_shifts/transpose_chord_ids.py --input_dir={input_dir} --output_dir={output_dir}"
