...
from src.utils import get_mel_spectrogram

def main(
    hop_length=4096,
    input_dir="data/processed/audio",
    output_dir="data/processed/cache/4096/mels",
    start_idx=None,
    end_idx=None,
):
    ...
    for filename in tqdm(filenames):
        ...
        torch.save(mel, f"{output_dir}/{filename}.pt")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="data/processed/cache/4096/mels",
