...
The model's outputs are good when audio has clearer pitch information. Once pitch information is distorted, the model cannot use wider context to discern the correct chord. Performance is also highly song dependent. The model's accuracies over songs in the test set have a standard deviation of $20\%$.
...
\begin{figure}[H]
    ...
    \caption{}\label{fig:someone_like_you}
\end{figure}