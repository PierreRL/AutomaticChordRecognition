...
models to address this. We extract embeddings from modern generative models for use as input features to an ACR classifier. We also create new training data using a chord-condition generative model. Finally, we rethink how the model predicts 
chords in time by incorporating beat estimation. While performance improvements are small, synthetic data shows 
promise in correcting model failures, and oracle beat estimation yields the strongest 
